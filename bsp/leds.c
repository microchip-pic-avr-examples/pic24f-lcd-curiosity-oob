...
#define LED_LED3_BLUE_LAT    LATBbits.LATB7
#define LED_LED1_LAT         LATCbits.LATC12
#define LED_LED2_LAT         LATCbits.LATC15

#define LED_LED3_RED_TRIS    TRISGbits.TRISG9
#define LED_LED3_GREEN_TRIS  TRISBbits.TRISB4
#define LED_LED3_BLUE_TRIS   TRISBbits.TRISB7
#define LED_LED1_TRIS        TRISCbits.TRISC12
#define LED_LED2_TRIS        TRISCbits.TRISC15
